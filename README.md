repeat wait()
until game:IsLoaded()
local TableChat = {"Banana On Top","Config By #Hkoaa","Modified by Dhairyash"}
spawn(function()
    while wait() do 
        pcall(function()
...
getgenv().Setting = {
    ...
    ["Webhook"] = {
        ["Enabled"] = true,
        ["Url Webhook"] = "https://discord.com/api/webhooks/1258009055897718795/Eq7O7E36vl9H6ZSN4pEqc8tpwvdWwyyXVPcnqhZ8KCshAiX1AyPHIwZYKyiNlhOJMtkp", --Your Url
    },
    ["Misc"] = {
